...
if ( ! function_exists( 'understrap_scripts' ) ) {
	...
	function understrap_scripts() {
		...
		wp_localize_script( 'understrap-scripts', 'dlinq_attendance_update', array(
			'ajax_url' => admin_url( 'admin-ajax.php' )
		));
		wp_enqueue_script( 'particle-js', get_template_directory_uri() . '/js/particles.min.js', array(), $js_version, false );
 ...
 */
function dlinq_enqueue_custom_admin_style() {
        wp_register_style( 'custom_wp_admin_css', get_template_directory_uri() . '/css/dlinq-admin.css', false, '1.0.0' );
        wp_enqueue_style( 'custom_wp_admin_css' );
}
add_action( 'admin_enqueue_scripts', 'dlinq_enqueue_custom_admin_style' );


/**
 * add custom js to admin backend
 */
function dlinq_admin_enqueue_js_scripts() {

    wp_enqueue_script( 'dlinq-admin-js', get_template_directory_uri() . '/js/dlinq-admin.js', array(), '1.0.0', true );
	wp_localize_script('dlinq-admin-js', 'dlinq_admin_enqueue_js_scripts', array(
